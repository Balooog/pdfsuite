...
| Doc | Purpose | Key Links | | --- | --- | --- | | `README.md` | Quick start + CLI overview | Link to `docs/OPERATOR_GUIDE.md`, `docs/PROJECT_LAUNCH.md`, GUI docs | | `docs/PROJECT_LAUNCH.md` | Original stack rationale + feature matrix | Cross-link to CLI commands, roadmap | | `docs/OPERATOR_GUIDE.md` | Task recipes & pipelines | Links to CLI reference, Doctor instructions | | `docs/CLI_REFERENCE/*.md` | Command-by-command syntax/behavior | Linked from Operator Guide and Typer help | | `docs/GUI_OVERVIEW.md` | UX principles & flows | Link to `docs/GUI_TECH.md`, `docs/GUI_WIREFRAMES.md` | | `docs/GUI_TECH.md` | Architecture & packaging | Link back to CLI utilities + CI plan | | `docs/GUI_WIREFRAMES.md` | Visual sketches | Link to overview + future screenshots | | `docs/GUI_USER_GUIDE.md` | Panel walkthrough (planned) | References Operator Guide + GUI Tech | | `docs/CONTRIBUTOR_GUIDE.md` | Dev workflow, coding standards | Link to Testing Handbook, Release Playbook | | `docs/TESTING_HANDBOOK.md` | Test layers, CI expectations | Link to Troubleshooting FAQ | | `docs/TROUBLESHOOTING_FAQ.md` | Common issues & fixes | Link to Security/Privacy | | `docs/SECURITY_PRIVACY.md` | Handling sensitive data | Link to Redaction/Security sections | | `docs/RELEASE_PLAYBOOK.md` | Release checklist & changelog template | Link to Roadmap | | `docs/ARCHITECTURE_OVERVIEW.md` | System diagram & components | Link to GUI Tech + Project Launch | | `docs/ROADMAP.md` | Milestones, branch rules | Link to Docs Index + Contributor Guide | | `docs/DOCS_INDEX.md` | (This file) – portal + publishing plan | Link to site root |
